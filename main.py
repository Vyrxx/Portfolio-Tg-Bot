...
def handle_messages(message):
    try:
        wait_msg = bot.reply_to(message, texts["waiting"])
...
def callback_msg(callback):
    if callback.data == "about":
        ...
        markup = types.InlineKeyboardMarkup()
        back = types.InlineKeyboardButton(texts["call_back"], callback_data='back')
        rps = types.InlineKeyboardButton(texts["call_rps"], callback_data='rps')
        study = types.InlineKeyboardButton(texts["call_study"], callback_data='study')
        tg = types.InlineKeyboardButton(texts["call_tg"], callback_data='tg')
        markup.row(rps,study)
        markup.row(tg,back)
        img = images["works"]
        text = texts["works"]
        new_media = types.InputMediaPhoto(
        ...
        markup = types.InlineKeyboardMarkup()
        back = types.InlineKeyboardButton(texts["call_back"], callback_data='works')
        link = types.InlineKeyboardButton(texts["call_link"], url="https://github.com/Vyrxx/Water-Reminder-BOT")
        markup.row(link, back)
        img = images["works"]
        text = texts["tg"]
        new_media = types.InputMediaPhoto(
            media=open(img, 'rb'),
    ...
    elif callback.data == "rps":
        markup = types.InlineKeyboardMarkup()
        back = types.InlineKeyboardButton(texts["call_back"], callback_data='works')
        link = types.InlineKeyboardButton(texts["call_link"], url="https://github.com/Vyrxx/RockPaperScissors")
        markup.row(link, back)
        img = images["works"]
        text = texts["rps"]
        new_media = types.InputMediaPhoto(
        ...
        markup = types.InlineKeyboardMarkup()
        back = types.InlineKeyboardButton(texts["call_back"], callback_data='works')
        link = types.InlineKeyboardButton(texts["call_link"], url="https://github.com/Vyrxx/Quiz---Study-App")
        markup.row(link, back)
        img = images["works"]
        text = texts["study"]
        new_media = types.InputMediaPhoto(
